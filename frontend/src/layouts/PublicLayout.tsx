      ...
      <div className="bg-brand-ink text-white">
        <div className="mx-auto flex max-w-7xl flex-col items-start gap-3 px-4 py-3 text-sm sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
          ...
          <div className="flex flex-wrap items-center gap-3 text-sm text-slate-300">
            <span className="max-w-md">Digital admissions and communication platform</span>
      ...
      <header className="sticky top-0 z-30 border-b border-slate-200/80 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-col gap-5 px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <Link
              to="/admissions"
              className="hidden rounded-full bg-brand-navy px-5 py-3 text-sm font-bold text-white lg:inline-flex"
            >
              Apply Now
            </Link>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-14 sm:px-6 lg:grid-cols-[1.3fr_1fr_1fr] lg:px-8">
          <div>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <Link
                to="/admissions"
                className="rounded-full bg-brand-gold px-5 py-3 text-center text-sm font-bold text-brand-ink"
              >
                Begin Admissions
              </Link>
              <Link
